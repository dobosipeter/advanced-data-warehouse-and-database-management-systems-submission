...
\subtitle{Advanced Data Warehouse}
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{../../diagrams/data_flow.png}
\end{figure}
\note{~1 min --- trace the flow: OpenAQ → staging → OLTP → ETL → DW → dashboard.}
\end{frame}

% ----------------------------------------------------------
\begin{frame}{Star Schema Design}
\begin{figure}
\centering
\includegraphics[width=0.78\textwidth]{../../diagrams/dw_star_schema.png}
\end{figure}
...
\begin{itemize}
  ...
  \item Metrics: MAE ≈ 0.91, RMSE ≈ 1.21, R² ≈ 0.73
